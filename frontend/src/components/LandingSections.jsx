    ...
    <section ref={ref} id="demo-form" className="py-24 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {submitted ? (
              <div className="bg-brand/10 border border-brand/30 p-8 text-center">
                <CheckCircle className="text-brand mx-auto mb-4" size={48} />
                <h3 className="text-2xl font-bold text-white mb-4">Thank You!</h3>
                <p className="text-gray-300 mb-4">
                  Our team will reach out within 1 business day from<br />
                  <span className="text-brand">{companyInfo.phone}</span> or <span className="text-brand">{companyInfo.email}</span>
                </p>
                <Button onClick={() => setSubmitted(false)} variant="outline" className="border-white/20 text-white">
              ...
              <form onSubmit={handleSubmit} className="bg-white/5 border border-white/10 p-8 space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-gray-400 text-sm block mb-2">Work Email *</label>
                    <Input
                      name="email"
                      type="email"
                  ...
                  <div>
                    <label className="text-gray-400 text-sm block mb-2">Phone / WhatsApp *</label>
                    <Input
                      name="phone"
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-gray-400 text-sm block mb-2">Designation</label>
                    <Input
                      name="designation"
                      value={formData.designation}
                      onChange={handleChange}
                      className="bg-white/5 border-white/20 text-white"
                      placeholder="e.g. Costing Manager"
                    />
                  </div>
                  <div>
                ...
                <div>
                  <label className="text-gray-400 text-sm block mb-2">Brief Requirements / Notes</label>
                  <Textarea
                    name="notes"
                    value={formData.notes}
                    onChange={handleChange}
                    className="bg-white/5 border-white/20 text-white min-h-[100px]"
                    placeholder="Tell us about your RFQ volume, current challenges, or specific requirements..."
                  />
                </div>

                <Button type="submit" className="w-full bg-brand text-black hover:bg-brand/90 py-6 text-lg">
                  Book a Demo
